"""
Memory and Learning Configuration — Nisaba Agent.
...
from .base import NisabaBaseSettings, PathMixin


class MemorySettings(NisabaBaseSettings, PathMixin):
    """
    Configuration for Nisaba's multi-layered persistent memory system.
    ...
    # URL pointing to the Nisaba-specific database (Nisaba_db)
    NISABA_DATABASE_URL: str = Field(
        default=os.environ.get(
            "NISABA_DATABASE_URL", "postgresql://yuri:3759@localhost:5432/Nisaba_db"
        ),
